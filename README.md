...
## Output:
<img width="951" height="766" alt="image" src="https://github.com/user-attachments/assets/6e5f6caa-d7c6-4629-b81c-0a9b7b086ac8" />


## Result:
the output is done and verified successfully
